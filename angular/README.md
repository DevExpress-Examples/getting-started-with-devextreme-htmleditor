# DevExtreme Angular HtmlEditor - Getting Started 
...
To get more help with Angular CLI, use `ng help` or go check out the [Angular CLI Overview and Command Reference](https://angular.io/cli) page.
